...
class TestComment:
    def test_str_method(self):
        ...
        assert hasattr(comment, "__str__"), "Comment should have __str__ method"
...
class TestNewsPost:
    def test_str_method(self):
        ...
        assert hasattr(post, "__str__"), "NewsPost should have __str__ method"
